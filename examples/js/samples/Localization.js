...
myCompanyNameSpace.localization_creationCompleteHandler=function (evt){
...
myCompanyNameSpace.SAMPLE_CONFIGS["Localization"]='<grid forcePagerRow="true" enableExport="true" id="grid" '+
    '							 dataProvider="eval__myCompanyNameSpace.Employee.employees" '+
    '                                    enableDrillDown="true"'+
    '									 enableFilters="true" enablePaging="true"'+
    '									 enablePreferencePersistence="true" enablePrint="true"'+
    '                                    preferencePersistenceKey="localization" on'+flexiciousNmsp.Constants.EVENT_CREATION_COMPLETE+'="myCompanyNameSpace.localization_creationCompleteHandler" '+
    ...
    '			<column headerText="Nom" labelFunction="myCompanyNameSpace.CustomMatchFilterControl_getFullName" />'+
    ...
    '			<column headerText="Département" dataField="department" filterOperation="Equals" filterControl="MultiSelectComboBox" filterComboBoxBuildFromGrid="true" filterComboBoxWidth="150"/>'+
    '			<column headerText="Téléphone" dataField="phoneNumber" />'+
    '			<column headerText="Actif" dataField="isActive" filterOperation="Equals" filterControl="TriStateCheckBox" footerOperation="count" footerLabel="Count:" footerOperationPrecision="0"/>'+
    '		</columns>'+
    '		</level>'+
    '	</grid>';